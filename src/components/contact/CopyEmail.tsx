...
import { useState } from 'react'; // CopyEmailButton에서 사용
...
export function EmailSendButton() {
  return (
    <a
      href={`mailto:${EMAIL}?subject=${encodeURIComponent('[D-MATE] 프로젝트 문의')}`}
      className="inline-flex items-center gap-3 bg-[#0B63AD] text-white text-[11px] tracking-[0.25em] uppercase font-semibold px-8 py-4 hover:bg-[#0a5699] transition-colors self-start md:self-auto shrink-0"
    >
      이메일 보내기
